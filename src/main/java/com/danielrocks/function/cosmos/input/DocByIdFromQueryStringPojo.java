...
public class DocByIdFromQueryStringPojo {
    ...
    /**
     * This function listens at endpoint "/api/DocByIdFromQueryStringPojo". Two ways to invoke it using "curl" command in bash:
     * 1. curl -d "HTTP Body" {your host}/api/DocByIdFromQueryStringPojo
     * 2. curl {your host}/api/DocByIdFromQueryStringPojo?id=<someid>
     */
