...
public class DocByIdFromQueryString {
    ...
    /**
     * This function listens at endpoint "/api/DocByIdFromQueryString". Two ways to invoke it using "curl" command in bash:
     * 1. curl -d "HTTP Body" {your host}/api/DocByIdFromQueryString
     * 2. curl {your host}/api/DocByIdFromQueryString?id=<someid>
     */
